...
export default function ActionRequestDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const timeline = [
    ...
    ["EXTERNAL EXECUTION", "NOT EXECUTED", true],
  ];
  ...
  return (
    <RegistryShell title="Action request detail" eyebrow="Decision evidence">
      ...
      <p className="mt-6 border border-red-200 bg-red-50 p-4 text-xs font-semibold text-red-800">EXTERNAL EXECUTION IS DISABLED. This record contains authorization evidence only.</p>
    </RegistryShell>
  );
}
